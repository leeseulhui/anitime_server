...
def check_file(file, suffix=''):
    ...
    if os.path.isfile(file) or not file:  # exists
        ...
        assert 'clearml' in sys.modules, "ClearML is not installed, so cannot use ClearML anitime_data. Try running 'pip install clearml'."
        return file
    else:  # search
        files = []
...
def check_dataset(data, autodownload=True):
    # Download, check and/or unzip anitime_data if not found locally
