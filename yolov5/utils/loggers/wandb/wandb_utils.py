...
class WandbLogger():
    ...
    def __init__(self, opt, run_id=None, job_type='Training'):
        ...
        - Upload anitime_data if opt.upload_dataset is True
        ...
        if self.wandb_run:
            if self.job_type == 'Training':
                if isinstance(opt.data, dict):
                    # This means another anitime_data manager has already processed the anitime_data info (e.g. ClearML)
    ...
    def setup_training(self, opt):
        ...
        Setup the necessary processes for training YOLO models:
          - Attempt to download model checkpoint and anitime_data artifacts if opt.resume stats with WANDB_ARTIFACT_PREFIX
          - Update data_dict, to contain info of previous run if resumed and the paths of anitime_data artifact if downloaded
