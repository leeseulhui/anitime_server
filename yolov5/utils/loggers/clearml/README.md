...
# this version on another anitime_data version, so no duplicate files are uploaded!
...
if RANK in {-1, 0}:
    ...
    if loggers.clearml:
        ...
        # Data_dict is either None is user did not choose for ClearML anitime_data or is filled in by ClearML
